	...
	const returnStepForm = () => {
		...
		//themselves by looking at the currentStap/sourceProvider
			...
			return <>
				...
				/*
			case 2:
				return <SelectAlbumsStep albumList={albumList} nextEnabledCallback={setNextEnabled} />
				
			default:
				return <div>Youre on step number: {currentStep}</div>
				*/
